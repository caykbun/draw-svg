...
void SoftwareRendererImp::rasterize_triangle( float x0, float y0,
  ...
  while (cy <= max_y) {
    ...
    sample_buffer[4 * s_idx] = (uint8_t)(color.r * 255);
    sample_buffer[4 * s_idx + 1] = (uint8_t)(color.g * 255);
    sample_buffer[4 * s_idx + 2] = (uint8_t)(color.b * 255);
    sample_buffer[4 * s_idx + 3] = (uint8_t)(color.a * 255);
